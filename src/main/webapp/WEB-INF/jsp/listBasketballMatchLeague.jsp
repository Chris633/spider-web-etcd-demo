...
<div class="col-md-10">
    ...
    <div>
        ...
        <script type="text/ng-template" id="add.do">
            <div class="modal-header">
                <h3 class="modal-title">联赛信息</h3>
            </div>
			<div class="modal-body">
				<form class="form-horizontal">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="leagueNameEnglish">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">LEAGUE NAME ABBR</label>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="leagueNameAbbr">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">LEAGUE NAME CHINESE</label>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="leagueNameChinese">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">SPORTTERY NAME</label>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="sportteryName">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">WIN310 NAME</label>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="win310Name">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label">PINNACLESPORTS NAME</label>
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="pinnaclesportsName">
						</div>
					</div>
                </form>
            </div>
...
<script>
    ...
    app.controller("matchController", function ($scope, $http, $modal) {
        $scope.matchList = [];
        $scope.loading = true;
        $http.get('listBasketballMatchLeague.do')
    ...
    app.controller('ModalInstanceCtrl', function ($scope, $http, $modalInstance, league) {
        ...
        $scope.league = league;
        $scope.ok = function () {
            $http.post('modifyBasketballLeague.do', {"league": JSON.stringify(league)}).success(function (response) {
                if (response.value == 0) {
                    alert("success")
                } else {
                    alert("failed")
    ...
    app.controller('addCtrl', function ($scope, $http, $modalInstance) {
    
    	$scope.ok = function () {
			var league=new Object();
			league.leagueNameEnglish=$("#leagueNameEnglish").val();
			league.leagueNameAbbr=$("#leagueNameAbbr").val();
			league.leagueNameChinese=$("#leagueNameChinese").val();
			league.sportteryName=$("#sportteryName").val();
			league.win310Name=$("#win310Name").val();
 			league.pinnaclesportsName=$("#pinnaclesportsName").val();
			league.otherName=$("#otherName").val();
            $http.post('modifyBasketballLeague.do', {"league": JSON.stringify(league)}).success(function (response) {
                if (response.value == 0) {
                    alert("success");
                    location.reload();
