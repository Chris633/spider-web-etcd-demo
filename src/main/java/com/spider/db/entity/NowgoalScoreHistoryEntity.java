 ...
 */
@Entity
@Table(name = "nowgoal_score_history", schema = "", catalog = "crawler")
public class NowgoalScoreHistoryEntity {
    ...
    public NowgoalScoreHistoryEntity() {

    }

    public NowgoalScoreHistoryEntity(NowgoalScoreEntity w500Entity) {
        ...
        this.matchTime = w500Entity.getStartDateTime();
        ...
        this.w500Id = w500Entity.getW500Id();
    ...
    public boolean equals(Object o) {
        ...
        NowgoalScoreHistoryEntity that = (NowgoalScoreHistoryEntity) o;
