...
public class TCrawlerSporttery implements java.io.Serializable {
	...
	public String toString() {
		return "TCrawlerSporttery [id=" + id + ", competitionNum="
				+ competitionNum + ", startDateTime=" + startDateTime
				+ ", bDate=" + bDate + ", lastUpdated=" + lastUpdated
				+ ", status=" + status + ", matchs=" + matchs + ", homeTeam="
				+ homeTeam + ", visitionTeam=" + visitionTeam
				+ ", winCountOne=" + winCountOne + ", statusOne=" + statusOne
				+ ", winCountTwo=" + winCountTwo + ", statusTwo=" + statusTwo
	...
	public TCrawlerSporttery from(TCrawlerSporttery crawlerSporttery) {
        ...
        this.uniqueId = crawlerSporttery.getUniqueId();
