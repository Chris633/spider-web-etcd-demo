 ...
 */
@Entity
@Table(name = "nowgoal_score", schema = "", catalog = "crawler")
public class NowgoalScoreEntity {
    ...
    public NowgoalScoreEntity(NowgoalScoreEntity w500Entity) {
        ...
        this.startDateTime = w500Entity.getStartDateTime();
    ...
    public NowgoalScoreEntity() {

    }

    public boolean needToSbc(NowgoalScoreEntity w500Entity) {
    ...
    public void setStartDateTime(Timestamp matchTime) {

        this.startDateTime = matchTime;
    }
    ...
    public boolean equals(Object o) {
        ...
        NowgoalScoreEntity that = (NowgoalScoreEntity) o;
    ...
    public boolean needUpdate(Object o) {
    	...
    	return !equals(o) && isTimeAdvanced((NowgoalScoreEntity) o);
    }

    private boolean isTimeAdvanced(NowgoalScoreEntity w500Entity) {
    	
//    	return this.updateTime.after(w500Entity.getUpdateTime()) || this.half.equals("完") || this.half.equals("中");
    	return this.updateTime.after(w500Entity.getUpdateTime());
    }
