 ...
 */
@Entity
@Table(name = "manual_matches_history", schema = "", catalog = "crawler")
public class ManualMatchesHistoryEntity {
	...
	public ManualMatchesHistoryEntity(ManualMatchesEntity manualMatchesEntity) {
    	this.europeId = manualMatchesEntity.getEuropeId();
    	this.uniqueId = manualMatchesEntity.getUniqueId();
    	this.w500Id = manualMatchesEntity.getW500Id();
    	this.durationTime = manualMatchesEntity.getDurationTime();
    	this.half = manualMatchesEntity.getHalf();
    	this.score = manualMatchesEntity.getScore();
    	this.halfScore = manualMatchesEntity.getHalfScore();
    	this.homeRedcard = manualMatchesEntity.getHomeRedcard();
    	this.awayRedcard = manualMatchesEntity.getAwayRedcard();
    }
	...
	public String toString() {
		return "ManualMatchesHistoryEntity [id=" + id + ", europeId="
				+ europeId + ", uniqueId=" + uniqueId + ", w500Id=" + w500Id
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ManualMatchesHistoryEntity other = (ManualMatchesHistoryEntity) obj;
		if (awayRedcard == null) {
