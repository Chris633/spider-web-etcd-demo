...
import com.spider.utils.HandicapLineConvertor;
import com.spider.utils.LogHelper;
import com.spider.utils.LotteryUtils;
import com.spider.utils.UpdateTimeUtils;
...
public class MatchOddsServiceImpl implements MatchOddsServcie {
    ...
    private static final Logger dupicateLogger = LogHelper.getDuplicateLogger();
...
//            			SportteryAllEntity sportteryAllEntity = sportteryAllRepository.findByMatchCode(sporttery.getCompetitionNum());
					...
					oddsModelRepository.deleteNonUniqueResult();
					sportteryAllRepository.deleteNonUniqueResult();
					dupicateLogger.error("duplicate oddsModel " + win310.getWin310EuropeId());
				}
            }
        }
        return oddslist;
