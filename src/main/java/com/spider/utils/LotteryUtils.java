...
public class LotteryUtils {
    ...
    public static List<String> getUniqueId(List<TCrawlerSporttery> sportteries) {

        Preconditions.checkNotNull(sportteries);

        List<String> uniqueIds = new ArrayList<>(sportteries.size());
        for (TCrawlerSporttery sporttery : sportteries) {
            uniqueIds.add(sporttery.getUniqueId().toString().trim());
        }
        return uniqueIds;
    }
